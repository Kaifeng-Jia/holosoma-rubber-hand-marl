"""Joint termination preset for the Plan 5 cooperative Push A1 baseline."""

from holosoma.config_types.termination import TerminationManagerCfg, TerminationTermCfg


g1_29dof_plan5_push_termination = TerminationManagerCfg(
    terms={
        ...
        "joint_bad_tracking": TerminationTermCfg(
            ...
            params={
                ...
                # Diagnostic threshold only: low torso height is recorded but does
                # not terminate training or evaluation.
...
__all__ = ["g1_29dof_plan5_push_termination"]
